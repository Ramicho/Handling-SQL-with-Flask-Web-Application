...
app.config['MYSQL_DATABASE_HOST'] = 'ramicho.c1opr7au6hpt.us-east-1.rds.amazonaws.com' #PLEASE WRITE YOUR aws rds DATABASE ENDPOINT HERE
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Password' #PLEASE WRITE YOUR PASSWORD HERE
app.config['MYSQL_DATABASE_DB'] = 'database-db' ##PLEASE WRITE YOUR DATABASE NAME HERE
...
if __name__ == '__main__': 
   # app.run(debug=True)        #local USAGE
   app.run(host='0.0.0.0', port=80) #ec2 USAGE
